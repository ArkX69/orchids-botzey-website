...
const FAQAccordionItem = ({ 
  ...
  return (
    <div className="border-b border-[rgba(255,255,255,0.08)] last:border-0 overflow-hidden">
      <button
        onClick={onToggle}
      ...
      >
        ...
        <div className={cn(
          "flex items-center justify-center w-8 h-8 rounded-full border border-[rgba(255,255,255,0.1)] transition-transform duration-300",
...
const FAQ = () => {
  ...
  return (
    <section className="relative w-full py-[120px] bg-[#030312]" id="faq">
      ...
      {/* Subtle Background Glow if needed - following design instructions of radiance */}
