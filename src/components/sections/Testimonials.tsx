...
export default function Testimonials() {
  ...
  return (
    <section className="relative overflow-hidden bg-background py-[120px]">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-[32px] md:text-[48px] font-semibold tracking-tight text-foreground">
              ...
              <div className="flex gap-4">
                <button 
                  onClick={prevSlide}
                  className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:border-primary/50 transition-all duration-300 glass-panel"
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="max-w-[800px]">
                    <blockquote className="text-[24px] md:text-[32px] font-medium leading-[1.3] text-foreground mb-10 italic">
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    index === activeIndex ? "w-8 bg-primary" : "w-1.5 bg-white/10"
                  }`}
                />
              ))}
            </div>
      ...
      <div className="absolute -bottom-1/4 -right-1/4 w-[800px] h-[800px] bg-primary/5 rounded-full blur-[120px] pointer-events-none z-0"></div>
    </section>
  );
}