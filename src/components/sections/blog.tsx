    ...
    <section className="relative w-full py-[120px] bg-[#030312] overflow-hidden">
      <div className="container mx-auto max-w-[1216px] px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <a
            href="/blog"
            className="group flex items-center gap-2 px-6 py-3 rounded-full border border-white/10 glass-panel hover:border-[#8a7bff]/50 transition-all duration-300 text-sm font-semibold text-white"
          >
            More Insights
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 glass-panel p-6 flex flex-col lg:flex-row gap-8 items-center group cursor-pointer hover:border-[#8a7bff]/30 transition-all">
            ...
            <div className="w-full lg:w-1/2 flex flex-col h-full py-2">
              <div className="mb-4">
                <span className="text-[10px] uppercase tracking-widest font-bold text-[#8a7bff] px-3 py-1 bg-[#8a7bff]/10 rounded-full">
                  [ AI AUTOMATION ]
                </span>
              </div>
              ...
              <div className="mt-auto flex items-center justify-between pt-6 border-t border-white/5">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#16162d] flex items-center justify-center overflow-hidden relative">
          ...
          {/* Small Article 1 */}
          <div className="glass-panel p-6 flex flex-col md:flex-row gap-6 group cursor-pointer hover:border-[#8a7bff]/30 transition-all">
