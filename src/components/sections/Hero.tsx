...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[1080px] flex items-center justify-center overflow-hidden bg-[#030312] pt-20">
      ...
      <div className="container relative z-10 w-full max-w-[1200px] flex flex-col md:flex-row items-center justify-between gap-12 px-6">
        {/* Left Content */}
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-gradient-to-t from-[rgba(138,123,255,0.05)] to-transparent pointer-events-none" />
    </section>
  );
}